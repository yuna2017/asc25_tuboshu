...
\begin{minipage}{0.45\textwidth}
    \centering
    \includegraphics[width=0.5\textwidth, height=3cm, keepaspectratio]{Li_Jinze.png}\\[0.3cm]
...
\begin{minipage}{0.45\textwidth}
    \centering
    \includegraphics[width=0.5\textwidth, height=3cm, keepaspectratio]{Fang_Yi.png}\\[0.3cm]
