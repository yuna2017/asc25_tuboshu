...
The five members of our team consist of one freshman and four juniors, and all five of us are from the same supercomputer group on campus. Before the ASC2025 competition was announced, our team members frequently engaged in in-depth discussions on parallel programming, C language, MPI, distributed system management, and other parallel computing knowledge. We learn and discuss together, which is the core factor that binds us as a team. To better participate in and advance the ASC2025 competition, the team invited senior students who have previously participated in such competitions to provide analysis and guidance, thereby formally establishing our team. The five of us perform our respective roles, each with our own strengths, and we understand and cooperate with each other, enabling us to tackle any challenges.
...
\begin{itemize}
    ...
    \item \textbf{Memory constraints}: UMICollapse maintained 40GB heap boundary during deduplication
\end{itemize}

\subsection{Quality Control Metrics}
The pipeline implements three-tier filtering: (1) Primary alignment filtering (F3980 flag) removed 17.3\% of genome-mapped reads; (2) UMI deduplication eliminated 22.4\% PCR duplicates; (3) Final binomial testing applied thresholds of d ≥20, u ≥3, and p <0.001. Background estimation from non-candidate positions showed global unconverted ratio of 0.0187±0.0023 (mean±SD).
...
\subsection{Resource-aware Pipeline Scheduling}
...
\subsubsection{Java Task Offloading}
...
\subsection{Heterogeneous Computing Framework}
